// ============================================================
// ghost_chess.ino  —  Ghost Chess (ESP-NOW two-board)
//
//   Each board only holds its OWN physical pieces (rows 1-2
//   for White, rows 7-8 for Black). The opponent's pieces are
//   shown as permanent purple ghost LEDs — no physical mirroring
//   of opponent moves required.
//
